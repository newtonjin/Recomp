...
class ReXApp : public ui::WindowedApp, public ui::WindowListener, public ui::WindowInputListener {
 ...
 protected:
  ...
  /// Called after Runtime::Setup(), before Runtime::LoadXexImage().
  /// Use this to inject export/variable mappings required during XEX import resolution.
  virtual void OnBeforeLoadXex() {}
