...
#include "generated/rb2_config.h"
...
class Rb2App : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<Rb2App>(ctx);
    }

    Rb2App(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "rb2", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        std::string log_file_cvar = "log.txt";
...
XE_DEFINE_WINDOWED_APP(rb2, Rb2App::Create)
