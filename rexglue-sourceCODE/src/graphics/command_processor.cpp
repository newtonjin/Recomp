...
bool CommandProcessor::ExecutePacketType3_XE_SWAP(memory::RingBuffer* reader, uint32_t packet,
  ...
  if (magic != kSwapSignature) {
    REXGPU_ERROR("ExecutePacketType3_XE_SWAP: invalid magic signature {:#010X}, expected {:#010X}",
                 magic, kSwapSignature);
  ...
  REXGPU_INFO("ExecutePacketType3_XE_SWAP: IssueSwap ptr={:#010X} width={} height={}",
